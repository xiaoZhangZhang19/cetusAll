...
export const TEST_GROUPS: TestGroup[] = [
  ...
  },
  {
    ...
    tests: [
      ...
      { id: 'limit-ui', name: 'UI 交互验证', description: '验证初始状态/余额/HALF-MAX/代币切换/到期下拉（需要账户存在limit订单）', script: 'test:e2e:limit:ui', priority: 'P1', tags: ['limit', 'ui'], estimatedSeconds: 60 },
    ],
  },
  {
    id: 'dca',
